...
@section('content-title', 'Crear Comercio')
  ...
  <div class="row">
    <div class="col-md-8">
      <form action="{{ route('admin.shops.store') }}" method="POST" enctype="multipart/form-data">
              ...
              <div id="phones-container">
                ...
                @foreach ($phones as $index => $phone)
                  <div class="input-group mb-2">
                    <input type="text" name="phones[]" value="{{ $phone }}" class="form-control"
                      placeholder="0364 442-1234">
          ...
          <div class="card-body">
            <div class="form-group">
              ...
              <textarea name="additional_details" id="additional_details" rows="4"
                ...
                placeholder="Servicios especiales, instalaciones, información importante...">{{ old('additional_details') }}</textarea>
        ...
        <div class="row mb-8">
          <div class="col-12">
            <button type="submit" class="btn btn-primary float-right">Crear Comercio</button>
    ...
    <div class="col-md-4">
      ...
      {{-- <div class="card">
        ...
        <div class="card-body">
          <div class="form-group">
            <label for="image">Imagen del comercio</label>
        ...
        <div class="card-body">
          <div class="form-group">
            ...
            <input type="url" name="website" id="website" class="form-control @error('website') is-invalid @enderror"
                   value="{{ old('website') }}" placeholder="https://www.ejemplo.com">
            @error('website')
              <span class="invalid-feedback">{{ $message }}</span>
            @enderror
          </div>
          ...
          <div class="form-group">
            ...
            <input type="text" name="facebook" id="facebook" class="form-control @error('facebook') is-invalid @enderror"
                   value="{{ old('facebook') }}" placeholder="usuario_facebook">
            @error('facebook')
              <span class="invalid-feedback">{{ $message }}</span>
            @enderror
          </div>
          ...
          <div class="form-group">
            ...
            <input type="text" name="instagram" id="instagram" class="form-control @error('instagram') is-invalid @enderror"
                   value="{{ old('instagram') }}" placeholder="@usuario_instagram">
            @error('instagram')
              <span class="invalid-feedback">{{ $message }}</span>
            @enderror
          </div>
        ...
        <div class="card-body">
          <div class="form-group">
            ...
            <input type="number" name="latitude" id="latitude" class="form-control @error('latitude') is-invalid @enderror"
                   value="{{ old('latitude') }}" step="0.0000001" placeholder="-26.795220">
            @error('latitude')
              <span class="invalid-feedback">{{ $message }}</span>
            @enderror
          </div>
          ...
          <div class="form-group">
            ...
            <input type="number" name="longitude" id="longitude" class="form-control @error('longitude') is-invalid @enderror"
                   value="{{ old('longitude') }}" step="0.0000001" placeholder="-60.445286">
            @error('longitude')
              <span class="invalid-feedback">{{ $message }}</span>
            @enderror
          </div>
