...
@section('content-title', 'Crear Elemento Histórico')
    ...
    <div class="col-md-12">
      <div class="card card-info">
        ...
        <div class="card-header">
          <h3 class="card-title">Crear Elemento Histórico</h3>
        </div>
        <form class="form-horizontal" method="POST" action="{{ route('admin.historical-items.store') }}"
          enctype="multipart/form-data" id="historical-item-form">
            ...
            <div class="form-group row">
              <div class="col-sm-12">
                ...
                <input id="title" class="form-control @error('title') is-invalid @enderror" name="title"
                  value="{{ old('title') }}" required autofocus placeholder="Ingrese el título del elemento histórico">
...
@push('scripts')
  ...
  <script>
    ...
    document.addEventListener("DOMContentLoaded", () => {
      // Verifica si el contenido antiguo es una cadena JSON válida
