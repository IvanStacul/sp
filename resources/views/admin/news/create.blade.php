    ...
    <div class="col-md-12">
      <div class="card card-info">
        ...
        <div class="card-header">
          <h3 class="card-title"> {{ __('news.titles.create') }} </h3>
        </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-md-5 col-sm-12">
                <label for="cover_image" class="col-form-label">
                  {{ __('news.forms.labels.cover_image') }} <span style="color:red">*</span>
                </label>

                <input id="cover_image" class="form-control @error('cover_image') is-invalid @enderror" name="cover_image"
                  type="file" value="{{ old('cover_image', $news->cover_image) }}" accept="image/*" required
