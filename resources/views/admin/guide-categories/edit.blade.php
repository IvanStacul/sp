...
@section('content-title', __('guide-categories.titles.edit'))
    ...
    <div class="col-md-12">
      <div class="card card-info">
        ...
        <div class="card-header">
          <h3 class="card-title"> {{ __('guide-categories.titles.edit') }} </h3>
        </div>
        <form class="form-horizontal" method="POST" action="{{ route('admin.guide-categories.update', $category) }}"
