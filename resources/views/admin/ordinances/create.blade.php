    ...
    <div class="col-md-12">
      <div class="card card-info">
        ...
        <div class="card-header">
          <h3 class="card-title"> {{ __('ordinances.titles.create') }} </h3>
        </div>
        <form class="form-horizontal" method="POST" action="{{ route('admin.ordinances.store') }}"
            ...
            <div class="form-group row">
              ...
              <div class="col-md-4 col-sm-12">
                <label for="file" class="col-form-label">
                  {{ __('ordinances.forms.labels.file') }} <span style="color:red">*</span>
                </label>

                <input id="file" class="form-control @error('file') is-invalid @enderror" name="file"
                  type="file" value="{{ old('file', $ordinance->file) }}" accept=".pdf" required
