      ...
      <div class="space-y-5 md:space-y-8">
          ...
          <nav class="-mb-px flex space-x-8" aria-label="Tabs">
            <button onclick="showTab('gastronomia')" id="tab-gastronomia"
              ...
              <svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-2 inline" fill="currentColor">
                ...
                <g>
                  <path
                    d="M7 12H3V2h4V12zM17 2h-4v10h4c1.1 0 2-.9 2-2V4C19 2.9 18.1 2 17 2zM15 19c-.6 0-1-.4-1-1s.4-1 1-1s1 .4 1 1S15.6 19 15 19zM5 19c-.6 0-1-.4-1-1s.4-1 1-1s1 .4 1 1S5.6 19 5 19zM1 14h18v2H1V14z" />
                </g>
              </svg>
              Gastronomía ({{ $gastronomia->count() }})
            </button>
            <button onclick="showTab('hoteles')" id="tab-hoteles"
              ...
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                stroke="currentColor" class="w-5 h-5 mr-2 inline">
          ...
          @if ($gastronomia->count() > 0)
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              @foreach ($gastronomia as $restaurant)
                @include('components.shop-card', ['shop' => $restaurant])
              @endforeach
            </div>
          @else
            <div class="text-center py-8">
              <div class="text-gray-400 text-lg">No hay restaurantes registrados en este momento.</div>
            </div>
          @endif
        </div>
        ...
        <div id="content-hoteles" class="tab-content hidden">
          <div class="mb-6">
            ...
            <p class="text-gray-600">Encuentra opciones de alojamiento cómodo y accesible para tu estadía en Sáenz Peña.
            </p>
          </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div class="hover:shadow-md group flex flex-col h-full bg-white border border-gray-200 shadow-sm rounded-xl">
              <div class="p-4 md:p-6">
                <h3 class="text-xl font-semibold text-gray-800">Hotel Aconcagua</h3>
                <p class="mt-2 text-gray-500">
                  SANTA FE 1650 / CASTELLI (CALLE 27 ENTRE 26 Y 28)
                </p>
                <p class="mt-2 text-gray-500 ">
            ...
            <div class="hover:shadow-md group flex flex-col h-full bg-white border border-gray-200 shadow-sm rounded-xl">
              <div class="p-4 md:p-6">
                <h3 class="text-xl font-semibold text-gray-800">Hotel A.MU.DO.CH</h3>
                <p class="mt-2 text-gray-500 ">
            ...
            <div class="hover:shadow-md group flex flex-col h-full bg-white border border-gray-200 shadow-sm rounded-xl">
              <div class="p-4 md:p-6">
                <h3 class="text-xl font-semibold text-gray-800">Hotel IL Colono</h3>
                <p class="mt-2 text-gray-500 ">
