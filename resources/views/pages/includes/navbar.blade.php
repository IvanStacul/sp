          ...
          <div class="menu-main-menu-container">
            <ul class="menu nav-menu lg:flex lg:items-center lg:gap-1 xl:gap-2">
              ...
              <li class="menu-item group">
                <a href="{{ route('services.index') }}" class="group-hover:!text-primary-800 group-hover:!border-primary-800">Servicios</a>
              </li>
                  ...
                  <div class="[&>div]:p-3 [&>div]:w-72 lg:flex lg:flex-wrap">
                    <div>
                      <ul class="space-y-1.5 xl:space-y-2 2xl:space-y-2.5" aria-labelledby="TramitesMenus">
                        <li class="menu-item">
                          <a href="" onclick="return false;">Trámites digitales</a>
                        </li>
                        <li class="menu-item">
                          <a href="" onclick="return false;">Autogetion (impuestos)</a>
                        </li>
                        <li class="menu-item">
                          <a href="" onclick="return false;">Guía de trámites</a>
                        </li>
                      </ul>
                    </div>
                  </div>
              ...
              <li class="menu-item group">
                <a href="{{ route('news.index') }}" class="group-hover:!text-primary-800 group-hover:!border-primary-800">Noticias</a>
              </li>

              <li class="menu-item group">
                <a href="{{ route('pages.institutional.index') }}" class="group-hover:!text-primary-800 group-hover:!border-primary-800">Institucional</a>
              </li>
                  ...
                  <div class="[&>div]:p-3 [&>div]:w-72 lg:flex lg:flex-wrap">
                    <div>
                      <ul class="space-y-1.5 xl:space-y-2 2xl:space-y-2.5" aria-labelledby="DocumentosMenus">
                        <li class="menu-item">
                          <a href="{{ route('ordinances.index') . '?category=ordenanzas' }}">Ordenanzas</a>
                        </li>
                        <li class="menu-item">
                          <a href="{{ route('ordinances.index') . '?category=ordenanzas-impositivas-y-tarifarias' }}">Ordenanzas impositivas y tributarias</a>
                        </li>
                        <li class="menu-item">
                          <a href="{{ route('docs') }}">Documentos Oficiales y resoluciones</a>
                        </li>
                      </ul>
                    </div>
                  </div>
        ...
        <nav class="main-navigation mb-4" aria-label="Main navigation">
          <div class="menu-main-menu-container">
            <ul id="navigation-dropdown-collapse" data-accordion="collapse" class="menu nav-menu">
              ...
              <li class="menu-item relative menu-item-has-children">
                <a href="" onclick="return false;">Institucional</a>

                <button class="submenu-btn flex-shrink-0" id="accordionInstitucional"
                  data-accordion-target="#accordion-collapse-institucional"
                  aria-controls="accordion-collapse-institucional">
                  <span>
                    <span class="sr-only">
                      mostrar submenú para "Institucional"
                    </span>
                  </span>
                ...
                <div id="accordion-collapse-institucional" class="submenu hidden bg-transparent"
                  aria-labelledby="accordionInstitucional">
                  <div class="[&>div]:p-3 [&_ul]:space-y-1.5">
                    <div>
                      <ul class="space-y-1.5 xl:space-y-2 2xl:space-y-2.5">
                        <li class="menu-item">
